...
var smooth_scroll_polyfills_min = __webpack_require__(164);
var smooth_scroll_polyfills_min_default = /*#__PURE__*/__webpack_require__.n(smooth_scroll_polyfills_min);
;// CONCATENATED MODULE: ./src/js/behaviors/scrolling.js
...
var scrolling_scroll = new (smooth_scroll_polyfills_min_default())('a[href*="#"]', {
  speed: scrollSpeed(),
  easing: 'easeInOutQuad',
  updateURL: false
});
/* harmony default export */ const scrolling = ((/* unused pure expression or super */ null && (scrolling_scroll))); // // deixar o scroll suave ao clicar em âncoras
...
// 	}
// });
;// CONCATENATED MODULE: ./src/js/modules/detect-mobile.js
function isMobile() {
...
/* harmony default export */ const detect_mobile = (isMobile);
;// CONCATENATED MODULE: ./src/js/behaviors/window-height.js
